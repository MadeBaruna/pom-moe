...
<div
	class="fixed top-0 z-50 h-16 w-full border-b backdrop-blur-md duration-150 {showBorder
		? 'border-white/5 bg-dark/30'
		: 'border-transparent'}"
/>
<div class="fixed top-0 z-50 flex h-16 w-full items-center justify-center">
